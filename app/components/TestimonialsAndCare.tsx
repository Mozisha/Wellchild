...
const testimonialsData = [
  {
    ...
    name: "Sofia Menendez",
    role: "Parent",
    imageSrc: "/therapist-1.png" // Added image source
  },
  {
    ...
    imageSrc: "/therapist-2.png" // Added image source
  },
];

// UPDATED: Now uses image paths for icons
...
export default function TestimonialsAndCare() {
  return (
    <section className="bg-white py-24 sm:py-32 relative overflow-x-hidden">
      {/* UPDATED: Decorative Shapes using Image components */}
      <Image
        src="/circle.png"
        alt=""
        aria-hidden="true"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="lg:col-span-2 relative">
              <Swiper
                ...
                breakpoints={{
                  // Show 2 slides on larger screens
                  1024: {
                    slidesPerView: 2,
                  }
                }}
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {careOptionsData.map((option, index) => (
            <div
              key={index}
              // UPDATED: Highlighted card background color
